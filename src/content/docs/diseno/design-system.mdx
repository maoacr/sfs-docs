...
5. **Field pattern**: `docs/src/assets/field-pattern.svg` es el elemento decorativo de fútbol. Cualquier cambio en la identidad gráfica del deporte debe reflejarse ahí.
