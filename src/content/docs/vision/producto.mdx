...
| **ORM** | Drizzle ORM | Schema en TypeScript, SQL explícito, migraciones versionadas con drizzle-kit, compatible con el pooler de Supabase |
| **Pagos** | Mercado Pago | Dominancia en Latinoamérica, cuotas, billetera digital |
| **Notificaciones** | In-app (DB) + Email (Resend) | Doble canal: badge + drawer en la app, emails transaccionales |
